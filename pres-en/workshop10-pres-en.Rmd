...
Additional datasets that are no longer used in the 3-hr version:
...
* Special case of RDA involving covariates
  * Models the linear effects of matrix X on matrix Y while controlling for a matrix W of .alert[covariates].
