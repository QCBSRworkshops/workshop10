...
plot(mite.part, 
     ...
     frame = FALSE,
     cex = 1.5,
     bg = c("pink", "skyblue"), # add colour!
     alpha = 90) # adjust transparency
```
...
Create 4 equally-spaced latitude groups in the `mite.xy` dataset. Then, run an LDA to classify mite sites into latitude groupings based on environmental variables (`SubsDens` and `WatrCont`). 
...
**Step 1:** Make 4 equally spaced latitude groups.
