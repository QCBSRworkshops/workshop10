...
Lineard discriminant analysis is not just a form to reduce dimensionality, but it is a robust classification procedure.
...
.pull-left[
You can do this using the `betadisper()` function in the `vegan` package.
