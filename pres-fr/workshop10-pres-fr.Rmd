...
list.of.packages <- c("remotes", "Hmisc", "labdsv", "MASS", "vegan", "MVPARTwrap", "mvpart")
...
* [MVPARTwrap](https://cran.r-project.org/package=MVPARTwrap)
...
```{R MVPARTwrap_install, eval = FALSE, echo=TRUE}
remotes::install_github("cran/MVPARTwrap")
