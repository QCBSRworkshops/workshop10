...
```{r echo=FALSE, out.width="60%", fig.cap="The basic structure of variation partitioning.", fig.align="center"}
...
```{r, echo=FALSE, out.width="90%", fig.cap="Representing variation partitioning results.", fig.align="center"}
