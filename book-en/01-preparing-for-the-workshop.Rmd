...
> *The `mvpart` package is no longer hosted on CRAN, but is still available from the archives. To install `mvpart`, go to the "Packages" tab on the bottom right panel of R Studio, and click on "Install Packages". Choose to install from Package Archive file, and select the .zip for mvpart, which should download when you click the link in the list of packages above.
